...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 25 14:03:35 2017
...
#Read in HC.intensity file
hcint=pd.read_csv("/data/keeling/a/szymbor2/Research/Sarah/HC.intensity_eari_Global.txt", sep="\s+")
yr=hcint.Year       #Years from 1979-2013
NHI=hcint.NH_HCI    #NH index
SHI=hcint.SH_HCI    #SH index
...
for time in precip: #Time
    for lat in precip[time]: #Lat
        for lon in precip[time][lat] : #Lon
            arr.append(np.corrcoef(precip[time][lat][lon],NHI))
